...
export const Features = () => {
  ...
  return <section className="py-20 md:py-24">
    <div className="container">
      <h2 className="text-5xl md:text-6xl font-medium text-center tracking-tighter ">Elevate your  <span className='from-[#FF1CF7] to-[#b249f8] font-semibold bg-clip-text text-transparent bg-gradient-to-b'>SEO</span> efforts.</h2>
